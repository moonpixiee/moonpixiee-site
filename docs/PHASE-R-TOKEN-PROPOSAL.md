...
4. **S-1 — Deferred (1 Aug 2026, session close):** Smoke remains a named, valueless destination; its value will be ratified by eye from rendered swatches in a daylight session. Interim treatment: all retired pinks route to House Red treatment; `--persian-plum #710C21` retires to Garnet treatment. (The §5 companion amendment stands — retired colors are re-tokenized by role, not replaced by hue.)
